...
public class Constants {
    ...
    public final static String FILE_UPLOAD_DIC = "C:\\Users\\hp\\Desktop\\lenovo-mall\\src\\main\\resources\\static\\upload\\";//上传文件的默认url前缀，根据部署设置自行修改
    //public final static String FILE_UPLOAD_DIC = "E:\\lenovo-mall\\src\\main\\resources\\static\\upload\\";//上传文件的默认url前缀，根据部署设置自行修改
